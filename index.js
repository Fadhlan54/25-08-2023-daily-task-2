...
const contohArray = [1, "imam", 28, 2, "Fadhlan", 20, 3, "jojo", 20];

// console.log(arr)

// console.log(`ini index kedua dari array arr ${arr[1]}`)

// for (let i = 0 - 1; i < contohArray.length; i++) {
...
console.log(contohObj[contohArray[0]]);
...
for (let i = 0; i < contohArray.length; i++) {
    if (i % 3 === 0) {
        ...
        console.log(`index array ke ${i}: ${contohObj.id}`);
    }
}
